...
const __dirname = pa.dirname(fileURLToPath(import.meta.url));
  ...
  constructor(options = {}) {
    ...
    if (hook) {
      ...
      if (CACHE.getGeneratorFunctionScript) {
        try {
          internal.GeneratorFunction = CACHE.getGeneratorFunctionScript.runInContext(
            _context,
            DEFAULT_RUN_OPTIONS
          );
        } catch (ex) {}
...
export { VMError, NodeVM, VM, VMScript };
